...
<hr>
<div id="stocklisthead" style="height: 50px; width:1900px; overflow:auto;overflow: hidden; border: none;">
...
<div id="stocklist" style="height: 650px; width:1900px; overflow:auto;border: none;">
