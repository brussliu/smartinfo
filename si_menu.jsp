...
<table style="width:1500px;" border="1">
	...
	<tr>
		...
		<td><div style="text-align:center;"><br>
			<input type=button value="発送商品管理" style="width:400px;height: 40px;" onclick="Efw('menu_goto',{page:'jsp/shipacting/si_ship_master.jsp',shop:'Smart-Bear'})">
			<br><br>
			<input type=button value="代行発送管理" style="width:400px;height: 40px;" onclick="Efw('menu_goto',{page:'jsp/shipacting/shipinfo.jsp',shop:'Smart-Bear'})">
			<br><br>
		</div></td>
	</tr>
</table>
