...
<head>
	...
	<script type="text/javascript" charset="UTF-8" src="jquerysession.js"></script>
        ...
        function changeColor(){
			...
			$("#stocktable").find("tr").each(function(){
			    ...
			    if(productkinds == "子商品"){
			    	...
			    	if(num3 < 10){
			    		tdArr.eq(19).css({"background": "rgb(255,153,255)"});

			    	}else if(num3 >= 10 && num3 < 30){
			    		tdArr.eq(19).css({"background": "rgb(255,204,255)"});
...
<table class="productlist" border="1" style="width: 100%;">
	...
	<tr>
		...
		<td style="font-size: 14px;" id="productdiv" colspan="4">
		</td>
		<td style="font-size: 16px;font-weight: bold;height: 40px;">
			表示項目
		</td>
...
<table border="1" id="stocktablehead" style="width: 1870px; font-size: 12px;">
	<tr>
		...
		<td style="width: 70px;" class="display3">LOCAL<br>在庫</td>
		<td style="width: 70px;" class="display3">ONBOARD<br>在庫</td>
		<td style="width: 70px;" class="display3">販売中<br>在庫合計</td>
		<td style="width: 70px;" class="display3">予備<br>在庫合計</td>
		<td style="width: 70px;" class="display3">全体<br>在庫合計</td>
